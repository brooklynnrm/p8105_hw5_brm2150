...
Let’s create a function for creating a normal distribution adn then
doing a t.test.
...
rnorm_t.test = function(u){
  ...
  broom::tidy(t.test(samp, conf.level = 0.95))
}
...
```
    ...
    1    0.125     0.121   0.905        29    -1.98      2.23 One Sampl… two.sided  
